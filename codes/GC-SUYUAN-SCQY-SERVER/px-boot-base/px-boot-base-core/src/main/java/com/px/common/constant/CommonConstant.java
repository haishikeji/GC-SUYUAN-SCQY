...
public interface CommonConstant {
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.px.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
    ...
    //二级市场订单
    public static final String ORDER_ORDER  = "order_order_";
    //防止重复提交
    public static final String ORDER_A_  = "order_a_";
    //防止重复提交二级市场
    public static final String ORDER_A_ORDER  = "order_a_order";
    public static final String ORDER_A_MH  = "order_a_mh";
    public static final String ORDER_A_HC  = "order_a_hc";
    //单个人已购买了几个藏品
    public static final String ORDER_A_PERSON  = "order_a_person";
    //藏品库存
    public static final String ORDER_Quantity_Stock  = "order_quantity_stock";
    //盲盒奖品数量
    public static final String ORDER_MH_NUM  = "order_mh_num";
    //藏品库存
    public static final String ORDER_SHOPPING  = "order_shopping_";
    //优先购
    public static final String SNAPCARD_NUM  = "snapcard_num";
    //藏品库存
    public static final String SNAPCARD_TIME  = "snapcard_time";
    /** 登录二维码 */
