...
import com.px.common.api.CommonAPI;
...
import com.px.common.system.vo.DictModel;
...
public class DictAspect {
    ...
    // 定义切点Pointcut
    @Pointcut("execution(public * com.px.modules..*.*Controller.*(..)) || @annotation(com.px.common.aspect.annotation.AutoDict)")
