package com.px.modules.system.controller;
...
import com.px.common.aspect.annotation.PermissionData;
import com.px.common.constant.CommonConstant;
import com.px.common.system.api.ISysBaseAPI;
import com.px.modules.base.service.BaseCommonService;
import com.px.common.system.query.QueryGenerator;
import com.px.common.system.util.JwtUtil;
import com.px.common.system.vo.LoginUser;
import com.px.common.util.*;
import com.px.modules.system.entity.*;
import com.px.modules.system.model.DepartIdModel;
import com.px.modules.system.model.SysUserSysDepartModel;
import com.px.modules.system.service.*;
import com.px.modules.system.vo.SysDepartUsersVO;
import com.px.modules.system.vo.SysUserRoleVO;
        ...
        for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
            ...
            try {
                ...
                for (int i = 0; i < listSysUsers.size(); i++) {
                    ...
                    //确保不会有空数据
                    if (sysUserExcel.getUsername()==null) {
                        errorMessage.add("有空数据请查看导入数据");
                        errorLines++;
